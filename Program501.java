    ...
    public void StartDBMS()
    {
        ...
        while(true)
        {
            ...
            if(QuerySize == 1)
            {
                ...
                {
                    System.out.println("This application is used to demonstrate the features of customisd DBMS");
                    System.out.println("Display all data : select * from student");
                    System.out.println("Insert new record : insrt into student values Name Marks");
